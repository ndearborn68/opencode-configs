...
**v1.5.68** · CLI **`oc`** · identity `jesseoue/opencode-configs`
...
| | |
| --- | --- |
| **Pins** | OpenConfig `1.5.68` · OpenCode `1.18.17+` · OmO `oh-my-openagent@4.19.4` · `@opencode-ai/plugin` `1.18.15` |
...
| --- | --- | --- |
| OpenConfig | `versions.json` → `opencode_configs` | `1.5.68` |
